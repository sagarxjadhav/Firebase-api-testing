...
/**
 * Add all initial exam data to Firebase
 */
export const addInitialDataToFirebase = async () => {
  console.log('🚀 Adding initial exam data to Firebase...');
  
  const results = [];
  
  for (const [examCode, examData] of Object.entries(initialExamData)) {
    try {
...
if (typeof window !== 'undefined') {
  window.addInitialData = addInitialDataToFirebase;
  console.log('Initial data function available on window.addInitialData');
}
